      ...
      <div className="flex items-center px-2 sm:px-4 overflow-x-auto">
        {sheets.map((sheet) => (
          <button
            ...
            className={`px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium border-t-2 transition-colors whitespace-nowrap ${
              sheet.id === activeSheetId
                ? "border-t-2 border-custom-green bg-custom-green/10 text-custom-green"
